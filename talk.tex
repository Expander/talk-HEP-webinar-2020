...
\begin{frame}{Problem: vorhergesagte Higgs-Masse zu klein?}
  ...
  vorhersagen, wenn es \emph{große Quantenkorrkturen} zwischen $M_h$
  und $m_h$ gibt!
  \begin{align*}
...
\begin{frame}{Berechnung bis zu endlicher Schleifenordnung}
  ...
  \begin{align*}
    \Delta m_h^2 = \fmfvcenter{htop} + \fmfvcenter{hstop} + \cdots
  \end{align*}
  \emph{Beobachtung:}
  \begin{itemize}
...
\begin{frame}{Los geht's! 1-Schleifen-Quantenkorrekturen}
  ...
  \end{align*}
  \\[1em]
  $M_t \approx 173.34\GeV$ = Masse des Top-Quarks \\
