...
\begin{frame}{Summary}
  ...
  %
  \vspace{1em}
  \emph{Recent advances in the calculation of $M_h$:}
  \begin{center}
    \begin{tabular}{lll}
      \toprule
      model $\rightarrow$ EFT & avail.\ accuracy & spec.\ gen. \\
      \midrule
      ...
      NMSSM $\rightarrow$ SM          & NLO + NLL & FS, SP \\
      MRSSM $\rightarrow$ SM          & NLO + NLL & FS, SP \\
      E$_6$SSM $\rightarrow$ SM       & NLO + NLL & FS, SP \\
      \bottomrule
    \end{tabular}
  \end{center}
\end{frame}
