...
\begin{frame}{Fixed-order calculation}
  \begin{center}
    \begin{tikzpicture}[scale=0.9]
      ...
      \draw[<-, thick, darkgreen] (4,1) -- (4.5,1) node[right]{$y_f^\MSSM, g_i^\MSSM$};
...
\begin{frame}{Scenarios with 1 light Higgs doublet}
  \begin{center}
    \begin{tikzpicture}[scale=0.8, every node/.style={transform shape}]
      ...
      \node at (2.5,7) {\textbf{I high-scale SUSY}};
      \draw[thick] (1,0)   rectangle node{SM}    (4,0.9);
      \draw[thick] (1,1.1) rectangle node{SM}   (4,4.9);
      \draw[thick] (1,5.1) rectangle node{MSSM}  (4,6);
      % 
      \node at (6.5,7) {\textbf{II split-SUSY}};
      \draw[thick] (5,0)   rectangle node{SM}    (8,1.9);
      \draw[thick] (5,2.1) rectangle node{SM + $\chi_i^{0,\pm}$ + $\tilde{g}$} (8,4.9);
...
\begin{frame}{Scenarios with 2 light/intermediate Higgs doublets}
  \begin{center}
    \begin{tikzpicture}[scale=0.8, every node/.style={transform shape}]
      \draw[->, thick] (0,0) -- (0,1) node[left]{$M_t$} -- (0,4) node[left]{$\MS$} -- (0,6);
      \node[align=center] at (2.5,7) {\textbf{III 2HDM}\\ (light $h_i$, $A$, $H^{\pm}$)};
      \draw[thick] (1,0)   rectangle node{SM} (4,0.9);
      \draw[thick] (1,1.1) rectangle node{2HDM} (4,4.9);
      \draw[thick] (1,5.1) rectangle node{MSSM} (4,6);
      % 
      \node[align=center] at (6.5,7) {\textbf{IV 2HDM+split}\\ (light $h_i$, $A$, $H^{\pm}$,\\ intermediate $\chi_i$, $\tilde{g}$)};
      \draw[thick] (5,0)   rectangle node{SM} (8,0.9);
      \draw[thick] (5,1.1) rectangle node{2HDM} (8,2.9);
      \draw[thick] (5,3.1) rectangle node[align=center]{2HDM\\ + $\chi_i^{0,\pm}$ + $\tilde{g}$} (8,4.9);
      \draw[thick] (5,5.1) rectangle node{MSSM} (8,6);
      % 
      \node[align=center] at (10.5,7) {\textbf{V 2HDM+split}\\ (light $\chi_i$, $\tilde{g}$, inter-\\ mediate $h_i$, $A$, $H^{\pm}$)};
      \draw[thick] (9,0)   rectangle node{SM} (12,0.9);
      \draw[thick] (9,1.1) rectangle node{SM + $\chi_i^{0,\pm}$ + $\tilde{g}$} (12,2.9);
      \draw[thick] (9,3.1) rectangle node[align=center]{2HDM\\ + $\chi_i^{0,\pm}$ + $\tilde{g}$} (12,4.9);
